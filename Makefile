...
KBUILD_CFLAGS   := -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs \
		   ...
		   -Wno-strict-prototypes -Wno-format-security \
		   -std=gnu89 \
		   -pipe
...
# CPU opts
#KBUILD_CFLAGS	+= -mcpu=cortex-a77+crc+crypto+sha2+aes+rcpc+dotprod -mtune=cortex-a77 -march=armv8.2-a+crc+crypto+lse+rdm -O3 -funroll-loops -fno-plt
#KBUILD_AFLAGS   += -mcpu=cortex-a77+crc+crypto+sha2+aes+rcpc+dotprod -mtune=cortex-a77 -march=armv8.2-a+crc+crypto+lse+rdm -O3 -funroll-loops -fno-plt
